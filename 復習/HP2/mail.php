...
$from = "otapanda.1111@gmail.com";

//フォームのメールアドレス入力箇所のname属性の値（name="○○"　の○○部分）
$Email = "otapanda.1111@gmail.com";
//---------------------------　必須設定　ここまで　------------------------------------
...
$Referer_check_domain = "https://otapan10.com/%e5%be%a9%e7%bf%92/HP2/html/contact.html";
...
$require = array('お問い合わせ項目','お名前（漢字）','メールアドレス','お問い合わせ内容');
